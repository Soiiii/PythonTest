...
#
# You can base your solution on this code: http://www.py4e.com/code3/roster/roster.py - this code is incomplete as
# you need to modify the program to store the role column in the Member table to complete the assignment.
#
...
# /Users/baeksoyoung/Documents/GitHub/Test/UsingDatabaseswithPython/roster_data.json
...
sql = 'SELECT User.name,Course.title, Member.role FROM \
